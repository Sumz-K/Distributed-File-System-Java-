...
class manager_server {
    ...
    public manager_server(ArrayList<String> datanodes) {
    ...
    class ConnectionHandler implements HttpHandler {
        ...
        private void delivery(Map<String, byte[]> map) {
            String url = "https://datanode1.run-ap-south1.goorm.site/fetchfile";
